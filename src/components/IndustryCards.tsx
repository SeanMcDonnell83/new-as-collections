...
const industries: IndustryCard[] = [
  {
    ...
    description:
      "Specialised commercial debt recovery for contractors, sub-contractors and suppliers on JCT and bespoke contracts.",
    icon: Building2,
  ...
  },
  {
    ...
    description:
      "No win, no fee debt recovery for restaurants, pubs, hotels and wholesalers in a high-insolvency sector.",
  ...
  },
  {
    name: "Oil & Gas / Energy",
    description:
      "High-value, multi-jurisdictional commercial debt recovery for complex energy supply chains.",
    icon: Flame,
  ...
  },
  {
    ...
    description:
      "Sensitive fee and bursary arrears recovery that protects parent relationships and school reputation.",
    icon: GraduationCap,
  ...
  },
  {
    ...
    description:
      "Enforcement of backdoor hires, transfer fees and disputed timesheets across permanent and temp placements.",
    icon: Briefcase,
  ...
  },
  {
    ...
    description:
      "Commercial debt recovery for freight charges, demurrage, warehousing and cross-border transport disputes.",
    icon: Ship,
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          ...
          >
            Specialised commercial debt recovery across key UK business sectors.
            Our sector-focused teams understand industry-specific challenges and
            operate on a transparent, no win, no fee basis where appropriate. We
            also serve other industries; these are just a few of the sectors
            where our team has deep expertise.
          </motion.p>
        </div>
