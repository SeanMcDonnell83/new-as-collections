  ...
  return (
    <div className={`min-h-screen ${themeClasses.bg.primary}`}>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="credit control, insolvency services, credit management, company insolvency, credit risk"
        />
        <link
          rel="canonical"
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                >
                  Complete outsourced credit management and specialist
                  insolvency services. Protect your business from bad debt and
                  manage insolvency risks effectively.
                </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                >
                  Our credit control outsourcing takes the burden of customer
                  account management off your team. Combined with specialist
                  insolvency guidance, we help you avoid costly bad debts.
                </p>
