...
import { Radar, CheckCircle, Database, Target, Lock, ArrowRight } from "lucide-react";
  ...
  const benefits = [
    {
      ...
      description: "Access to comprehensive UK and international debtor databases"
    },
    {
      icon: Target,
  ...
  return (
    <div className={`min-h-screen ${themeClasses.bg.primary}`}>
      <Helmet>
        ...
        />
        <meta name="keywords" content="debtor tracing, skip tracing, legal action, court claims, debtor location services" />
        <link rel="canonical" href="https://ascollections.co.uk/services/debtor-tracing" />
      </Helmet>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className={`text-xl ${themeClasses.text.secondary} mb-8 font-inter leading-relaxed`}>
                  Advanced debtor tracing combined with court claims and legal enforcement. We locate debtors and pursue recovery through the courts when necessary.
                </p>
              ...
              >
                ...
                >
                  ...
                  <circle cx="200" cy="200" r="20" fill="none" stroke="#2563eb" strokeWidth="2" opacity="0.5" />
                  <circle cx="200" cy="200" r="60" fill="none" stroke="#2563eb" strokeWidth="1" opacity="0.3" />
                  <circle cx="200" cy="200" r="100" fill="none" stroke="#2563eb" strokeWidth="1" opacity="0.2" />
                  <circle cx="200" cy="200" r="140" fill="none" stroke="#2563eb" strokeWidth="1" opacity="0.1" />

                  {/* Radar grid */}
                  <line x1="200" y1="60" x2="200" y2="340" stroke="#2563eb" strokeWidth="1" opacity="0.2" />
                  <line x1="60" y1="200" x2="340" y2="200" stroke="#2563eb" strokeWidth="1" opacity="0.2" />
                  <line x1="100" y1="100" x2="300" y2="300" stroke="#2563eb" strokeWidth="1" opacity="0.2" />
                  <line x1="300" y1="100" x2="100" y2="300" stroke="#2563eb" strokeWidth="1" opacity="0.2" />
                  ...
                  >
                    <line x1="200" y1="200" x2="200" y2="60" stroke="#dc2626" strokeWidth="2" opacity="0.8" />
                    <path
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className={`text-lg ${themeClasses.text.secondary} mb-8 font-inter leading-relaxed`}>
                  When standard collection fails, we deploy advanced tracing techniques combined with legal action. Our expert team locates debtors and pursues recovery through the courts.
                </p>
