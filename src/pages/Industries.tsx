...
const Industries = () => {
  ...
  return (
    <div className={`min-h-screen ${themeClasses.bg.primary}`}>
      <Helmet>
        <title>
          Debt Collection by Sector | Construction, Recruitment & More | A.S.
          Collections
        </title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="Debt Collection by Sector | Construction, Recruitment & More | A.S. Collections"
        />
        <meta
          property="og:description"
          content="Industry-specific debt recovery across UK sectors. Construction, food & drink, oil & gas, recruitment, logistics."
        />
      ...
      <main>
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p
              className={`text-lg ${themeClasses.text.secondary} max-w-4xl mx-auto font-inter leading-relaxed mb-4`}
            >
              Industry-specific debt recovery expertise across all UK business
              sectors. Our specialists understand the unique challenges and
              regulations within each industry.
            </p>
            <p
              className={`text-lg ${themeClasses.text.secondary} max-w-4xl mx-auto font-inter leading-relaxed mb-8`}
            >
              We enable higher success rates whilst protecting your valuable
              business relationships.
            </p>

            {/* Key Industries Overview */}
            <div
              className={`${themeClasses.bg.secondary} rounded-2xl p-8 border ${themeClasses.border.primary} max-w-4xl mx-auto backdrop-blur-sm`}
            >
              <h2
                className={`text-2xl font-bold ${themeClasses.text.primary} mb-6 font-montserrat font-700`}
              >
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-left">
                {[
                  ...
                  <div
                    key={index}
                    className={`${themeClasses.text.secondary} font-inter flex items-center`}
                  >
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-20">
              ...
              <p
                className={`text-lg ${themeClasses.text.secondary} max-w-3xl mx-auto font-inter leading-relaxed mb-8`}
              >
                We adapt our proven methodologies to suit your industry's
                specific requirements and challenges.
              </p>
            </div>

            <div
              className={`${themeClasses.bg.primary} rounded-2xl border ${themeClasses.border.primary} p-8 mb-12 backdrop-blur-sm`}
            >
              <h3
                className={`text-2xl font-bold ${themeClasses.text.primary} mb-6 font-montserrat font-700 text-center`}
              >
              ...
              {[
                {
                  ...
                  description:
                    "Deep understanding of industry-specific challenges, payment terms, and business practices ensures more effective debt recovery strategies.",
                },
                {
                ...
                >
                  ...
                  <p
                    className={`${themeClasses.text.secondary} font-noto-sans leading-relaxed`}
                  >
                    {benefit.description}
                  </p>
                </motion.div>
        ...
        >
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              Contact our specialists to discuss your specific industry
              requirements. We'll explain how our sector-focused approach can
              help recover your outstanding debts whilst protecting your
              business relationships.
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-12">
              {[
                ...
                <div key={index} className="text-center">
                  <div
                    className={`text-3xl font-bold ${themeClasses.text.accent} font-noto-serif mb-1`}
                  >
                    {item.stat}
                  </div>
                  <div
