  ...
  const serviceFeatures = [
    {
      ...
      description: "Cross-border commercial debt collection specialists with global reach and expertise in international trade disputes.",
      features: [
    ...
    },
    {
      ...
      description: "Advanced debtor location services using cutting-edge technology and extensive databases to track down elusive debtors.",
      features: [
    ...
    },
    {
      ...
      description: "Complete outsourced credit control solutions and specialist insolvency services for complex commercial situations.",
      features: [
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <div className={`text-sm ${themeClasses.text.secondary} flex items-center font-noto-sans`}>
              ...
              <div className={`${themeClasses.bg.secondary} rounded-2xl p-8 border ${themeClasses.border.primary}`}>
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="text-center">
                    <div className={`text-3xl font-bold ${themeClasses.text.accent} font-noto-serif`}>98%</div>
                    <div className={`text-sm ${themeClasses.text.secondary} font-noto-sans`}>Success Rate</div>
                  </div>
                  <div className="text-center">
                    <div className={`text-3xl font-bold ${themeClasses.text.accent} font-noto-serif`}>14 Days</div>
                    <div className={`text-sm ${themeClasses.text.secondary} font-noto-sans`}>Average Recovery</div>
                  </div>
                  <div className="text-center">
                    <div className={`text-3xl font-bold ${themeClasses.text.accent} font-noto-serif`}>£50M+</div>
                    <div className={`text-sm ${themeClasses.text.secondary} font-noto-sans`}>Total Recovered</div>
                  </div>
                  <div className="text-center">
                    <div className={`text-3xl font-bold ${themeClasses.text.accent} font-noto-serif`}>2,500+</div>
                    <div className={`text-sm ${themeClasses.text.secondary} font-noto-sans`}>Clients Served</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className={`text-xl ${themeClasses.text.secondary} max-w-3xl mx-auto font-noto-sans font-light`}>
                Comprehensive commercial debt collection solutions tailored to your specific business needs 
                and industry requirements across the UK and internationally.
              </p>
            </motion.div>
                ...
                >
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                    <div>
                      ...
                      <p className={`${themeClasses.text.secondary} leading-relaxed font-noto-sans text-lg mb-6`}>
                        {service.description}
                      </p>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      {service.features.map((feature, featureIndex) => (
                        <div key={featureIndex} className="flex items-start">
                          ...
                          <span className={`${themeClasses.text.secondary} text-sm font-noto-sans`}>
                            {feature}
                          </span>
                        </div>
                      ))}
        ...
        >
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className={`text-xl ${themeClasses.text.secondary} mb-8 font-noto-sans`}>
              Speak to our commercial debt recovery specialists today. Free consultation with no obligation 
              and no upfront costs. We only get paid when we successfully recover your debt.
            </p>
