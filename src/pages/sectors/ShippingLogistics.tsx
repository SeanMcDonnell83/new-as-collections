      ...
      <main>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <p className="text-xl text-slate-300 mb-8 max-w-lg font-medium">
                  Demurrage charges? Port liens? Cross-border disputes? 
                  We enforce payment across the global supply chain, from sender to receiver.
                </p>
                <div className="flex flex-wrap gap-4">
                  <Link to="/services/international-debt-collection">
                    <Button className="bg-blue-600 hover:bg-blue-500 text-white font-bold text-lg px-8 py-6 rounded-none skew-x-[-10deg] hover:skew-x-0 transition-all">
                      <span className="skew-x-[10deg] hover:skew-x-0 inline-block">GLOBAL RECOVERY</span>
                    </Button>
                  </Link>
                  <Link to="/winding-up-check">
                    <Button variant="outline" className="bg-transparent border-slate-500 text-white hover:bg-slate-800 font-bold text-lg px-8 py-6 rounded-none skew-x-[-10deg] hover:skew-x-0 transition-all">
                      <span className="skew-x-[10deg] hover:skew-x-0 inline-block">CHECK RISK</span>
                    </Button>
                  </Link>
                </div>
              </motion.div>
        ...
        <section className="py-24 bg-white overflow-hidden">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
            <h2 className="text-4xl font-black text-slate-900">THE SUPPLY CHAIN BREAKDOWN</h2>
          </div>
          ...
          >
            {[
              ...
              <div key={idx} className="w-[400px] bg-slate-50 p-8 border border-slate-200 rounded-none flex-shrink-0 hover:bg-blue-50 transition-colors">
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="p-4 bg-slate-800 border-l-4 border-blue-500">
                    ...
                    <p className="text-sm text-slate-400">Legal cargo holding</p>
                  </div>
                  <div className="p-4 bg-slate-800 border-l-4 border-blue-500">
              ...
              <div className="relative">
                <div className="bg-blue-600 p-12 transform rotate-2 shadow-2xl">
                  <h3 className="text-3xl font-black mb-4 uppercase">No Win, No Fee</h3>
        ...
        <section className="py-20 bg-blue-50">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <Link to="/contact">
                <Button variant="outline" className="bg-transparent border-blue-900 text-blue-900 hover:bg-blue-100 font-bold text-xl px-10 py-8 rounded-none">
                  GET A QUOTE
                </Button>
              </Link>
            </div>
