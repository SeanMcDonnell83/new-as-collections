...
const PrivateSchoolsEducation = () => {
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-serif selection:bg-indigo-100 selection:text-indigo-900 overflow-x-hidden">
      <Helmet>
        <title>
          School Fee Debt Recovery | Independent Education Specialists
        </title>
        <meta
          name="description"
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <span className="text-indigo-900 font-sans font-bold tracking-widest text-sm uppercase">
                    Independent Education Sector
                  </span>
                </div>
                <h1 className="text-5xl md:text-7xl font-serif font-medium text-slate-900 mb-8 leading-tight">
                  Discretion. <br />
                  <span className="italic text-indigo-800">Dignity.</span>{" "}
                  <br />
                  Recovery.
                </h1>
                <p className="text-xl text-slate-600 mb-10 max-w-lg font-sans leading-relaxed">
                  We understand the delicate balance between financial necessity
                  and pastoral care. Recover unpaid fees without damaging your
                  school's reputation or parental relationships.
                </p>
                <div className="flex flex-wrap gap-6 font-sans">
                  ...
                  <Link to="/services/commercial-debt-recovery">
                    <Button
                      variant="outline"
                      className="bg-transparent border-indigo-900 text-indigo-900 hover:bg-indigo-50 font-medium text-lg px-8 py-6 rounded-sm"
                    >
                      Our Approach
                    </Button>
                  </Link>
              ...
              >
                ...
                <div className="relative bg-white p-12 rounded-sm shadow-2xl border border-slate-200 max-w-md mx-auto rotate-1 hover:rotate-0 transition-transform duration-700">
                  <div className="border-b-2 border-indigo-100 pb-6 mb-6">
                    <h3 className="font-serif text-2xl text-slate-900 italic">
                      The Bursar's Dilemma
                    </h3>
                  </div>
                  <div className="space-y-6 font-sans text-slate-600">
                    <p>
                      "How do we chase the fees when the child is still in the
                      classroom?"
                    </p>
                    <p>
                      "We can't send bailiffs to a parent's door—the reputation
        ...
        <section className="py-24 bg-white font-sans">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-serif font-medium text-slate-900 mb-4">
                The Challenges of School Fees
              </h2>
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-xl text-slate-300 mb-8 leading-relaxed font-light">
                  We use a "soft" but firm approach. We act as a third party to
                  separate the financial dispute from the educational
                  relationship, allowing your staff to focus on the students.
                </p>
                <div className="space-y-6">
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-400">
                        We contact parents respectfully, understanding that
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-400">
                        We enforce terms regarding notice periods and interest
                        without aggression.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-400">
                        Securing payment plans or full settlement so the child's
                        education continues.
                      </p>
                    </div>
                  </div>
        ...
        <section className="py-20 bg-indigo-50 font-sans">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <p className="text-xl text-slate-600 mb-10">
              Speak to our education sector specialists today for a confidential
              discussion.
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <Link to="/winding-up-check">
                <Button
                  variant="outline"
                  className="bg-white border-indigo-200 text-indigo-900 hover:bg-indigo-50 font-medium text-lg px-10 py-6 rounded-sm"
                >
