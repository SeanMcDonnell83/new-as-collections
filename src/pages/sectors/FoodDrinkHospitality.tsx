    ...
    <div className={`min-h-screen ${themeClasses.bg.primary}`}>
      ...
      <main>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.2 }}>
                <h1 className={`text-5xl md:text-6xl font-manrope font-bold ${themeClasses.text.primary} mb-6`}>Food & Drink Industry Debt Recovery</h1>
                <p className={`text-xl ${themeClasses.text.secondary} mb-8 font-inter leading-relaxed`}>
                  Specialists in hospitality sector debt recovery. We understand the challenges of the food and drink industry and recover debts from restaurants, pubs, hotels and suppliers.
                </p>
        ...
        <motion.section initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className={`py-20 ${themeClasses.bg.primary}`}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className={`text-4xl font-manrope font-bold ${themeClasses.text.primary} mb-12 text-center`}>Hospitality Sector Expertise</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {["Restaurant & Pub Debts", "Hotel Payment Recovery", "Supplier & Wholesale Disputes", "Seasonal Business Challenges", "Multi-location Coordination", "Stock & Equipment Disputes"].map((item, idx) => (
        ...
        <motion.section initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className={`py-16 ${themeClasses.bg.secondary}`}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className={`text-3xl md:text-4xl font-manrope font-bold ${themeClasses.text.primary} mb-6`}>Recover Your Hospitality Debts</h2>
