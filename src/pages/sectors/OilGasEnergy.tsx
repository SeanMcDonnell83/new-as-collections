            ...
            <div className="max-w-4xl">
              ...
              >
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <span className="text-orange-500 font-bold tracking-widest uppercase">
                ...
                <p className="text-2xl text-slate-400 mb-10 max-w-2xl font-light leading-relaxed">
                  ...
                  Cross-border enforcement for the energy sector's most complex
                  disputes.
                </p>
                <div className="flex flex-wrap gap-6">
                  ...
                  <Link to="/services/international-debt-collection">
                    <Button
                      variant="outline"
                      className="bg-transparent border-slate-600 text-white hover:bg-slate-800 font-bold text-lg px-10 py-6 rounded-none"
                    >
                      GLOBAL RECOVERY
                    </Button>
                  </Link>
            ...
            <div className="grid lg:grid-cols-3 gap-12">
              <div className="lg:col-span-1">
                ...
                <p className="text-slate-400 text-lg">
                  These aren't £500 invoices. They are £50k - £500k+ liabilities
                  that threaten your operational stability.
                </p>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <div className="order-2 md:order-1">
                <div className="relative">
                  ...
                  <Globe
                    className="w-64 h-64 text-slate-800 mx-auto relative z-10"
                    strokeWidth={0.5}
                  />
              ...
              <div className="order-1 md:order-2">
                ...
                <p className="text-xl text-slate-400 mb-8 leading-relaxed">
                  We have the legal weight to cut through the noise. Whether
                  it's a drilling contractor in the North Sea or an equipment
                  rental firm in the Middle East, we handle the cross-border
                  complexity.
                </p>
        ...
        <section className="py-24 bg-orange-600">
          <div className="max-w-5xl mx-auto px-4 text-center">
            ...
            <p className="text-xl text-orange-100 mb-12 max-w-2xl mx-auto">
              Don't let a single operator failure bring down your business.
              Check their solvency now.
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-6">
              ...
              <Link to="/contact">
                <Button
                  variant="outline"
                  className="bg-transparent border-white text-white hover:bg-white/10 font-bold text-xl px-12 py-6 rounded-none"
                >
